...
sub new
 {
	...
	elsif (defined($ENV{'VAAST_SO_SOURCE'})){
		$self->source($ENV{'VAAST_SO_SOURCE'});
	}
	else {
		print "\n#######################################################\n";
		print "Error in Ontology::SO.pm.\n";
		print "You must either set the VAAST_SO_SOURCE environment varible\n";
...
sub AUTOLOAD
 {
	    ...
	    print STDERR "Ontology::SO::AutoLoader called for: ",
	    "\$self->$call","()\n";
